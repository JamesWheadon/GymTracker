...
fun convertToKilometers(unit: DistanceUnits, distance: Double): Double = round((distance / unit.kilometerConversion) * 100) / 100

fun convertToDistanceUnit(unit: DistanceUnits, distance: Double): Double = round((distance * unit.kilometerConversion) * 100) / 100
